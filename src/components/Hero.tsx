      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Hugo Pavão
            <span className="block text-2xl sm:text-3xl lg:text-4xl font-normal mt-2 opacity-95">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button 
              ...
              variant="outline"
              size="lg"
              className="bg-white/10 hover:bg-white/20 text-white border-white/30 hover:border-white/50 text-lg px-8 py-4 h-auto backdrop-blur-sm transition-all duration-300"
            >
              Saiba Mais
            </Button>
          </div>
